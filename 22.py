...
try:
    response = requests.get("https://raw.githubusercontent.com/praveen-045-file/User/main/Paid-list.txt")
...
Pyobscura =render('Pyobscura ',colors=stein_colors,align='center',font='block',background='black')
QE=render('Telegram: @Pyobscura  | Join @Pyobscura \nV5.0 ',colors=qe_colors,align='right',font='console',background='black')
print(Pyobscura )
print(QE)
time.sleep(1)
c1='\x1b[38;5;120m'
...
♻ RESET :: {reset_email}
══✪══✪══✪══
💻 TOOL BY @Pyobscura  | @Pyobscura 
""";inline_keyboard=[[{'text':'Developer','url':'https://t.me/Pyobscura '},{'text':'Join Channel','url':'https://t.me/Pyobscura '}]];payload={'chat_id':user_id,'text':ss,'reply_markup':json.dumps({'inline_keyboard':inline_keyboard})}
