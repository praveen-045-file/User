...
def check_id_validity(input_id):
    ...
    print("\033[1m\n[⚠️] You are not a paid user. Buy a subscription ~ @GL1T5 (TG)\033[0m")
    return False
...
━━━━━━━━━━━━━━━
💻 ＴＯＯＬ ＢＹ ➤ @GL1T5 
""";inline_keyboard=[[{'text':'Developer','url':'https://t.me/GL1T5'},{'text':'Join Channel','url':'https://t.me/GLITCH_ARMY'}]];payload={'chat_id':ID,'text':ss,'reply_markup':json.dumps({'inline_keyboard':inline_keyboard})}
